...
const enUS: ServerWebMessages = {
  ...
  adminSystem: {
    ...
    smtpSettingsSummary: 'Configure delivery for verification emails.',
    testConnection: 'Test connection',
    testingConnection: 'Testing',
    connectionSuccess: 'SMTP connection succeeded',
    passwordKeepPlaceholder: 'Leave blank to keep the current value',
    verificationSecurity: 'Verification security',
    testEmailTitle: 'Send test email',
    testEmailSummary: 'Choose a template and send it to a recipient.',
    ...
    templatesSummary: 'Edit the subject and HTML used by verification emails.',
    customTemplate: 'Customized',
    officialTemplate: 'Official template',
    templateSubject: 'Subject',
    templateHtml: 'HTML template',
    templatePlaceholders: 'Available placeholders',
    insertPlaceholder: 'Insert into the HTML template',
    templatePreview: 'Live preview',
    previewTemplate: 'Preview',
    restoreTemplate: 'Restore official',
    restoreTemplateConfirm: 'Restore the official template? Your current changes will be removed.',
    saveTemplate: 'Save template',
    templateSaved: 'Email template saved',
    templateRestored: 'Official template restored',
    secretSet: 'Set',
  ...
  errors: {
    ...
    smtpConnectionFailed: 'SMTP connection failed. Check the host, port, username, and authorization code. Details: {detail}',
    smtpSendFailed: 'SMTP email delivery failed. Details: {detail}',
