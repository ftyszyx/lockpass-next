...
const enUS: LocaleMessages = {
  ...
  editor: {
    ...
    cardIssuer: "Issuer",
    cardPhoneLocal: "Phone (local)",
    cardPhoneTollFree: "Phone (toll free)",
    cardPhoneInternational: "Phone (international)",
    cardWebsite: "Website",
    notes: "Notes",
  ...
  backup: {
    ...
    legacyImportSuccess:
      "Imported {count} items and {vaults} vaults from legacy backup",
