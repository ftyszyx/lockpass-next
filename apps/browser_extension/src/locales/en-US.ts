...
const enUS: LocaleMessages = {
  ...
  auth: {
    ...
    server: 'Server',
    officialServer: 'LockPass official server',
    selfHostedServer: 'Self-hosted server',
    editServer: 'Edit server',
    customServerTitle: 'Self-hosted server',
    customServerUrl: 'Server address',
  ...
  error: {
    ...
    serverUrlInvalid: 'The server address is invalid.',
