...
import { t, useI18n, type ServerWebLocale } from '@/i18n'
...
const navGroups = computed(() => [
  {
    label: t('layout.userConsole'),
    items: [
      { to: '/console', label: t('layout.overview'), ariaLabel: t('layout.userOverview'), icon: LayoutDashboard },
      { to: '/console/local-accounts', label: t('layout.localAccounts'), ariaLabel: t('layout.userLocalAccounts'), icon: UserCircle },
      { to: '/console/devices', label: t('layout.devices'), ariaLabel: t('layout.userDevices'), icon: MonitorSmartphone },
      { to: '/console/sync-data', label: t('layout.syncData'), ariaLabel: t('layout.userSyncData'), icon: TableProperties },
      { to: '/console/sync-events', label: t('layout.syncEvents'), ariaLabel: t('layout.userSyncEvents'), icon: ScrollText }
    ]
  },
  ...(session.isAdmin ? [{
    ...
    items: [
      ...
      { to: '/admin/local-accounts', label: t('layout.localAccounts'), ariaLabel: t('layout.adminLocalAccounts'), icon: UserCircle },
      { to: '/admin/sync-data', label: t('layout.syncData'), ariaLabel: t('layout.adminSyncData'), icon: TableProperties },
      { to: '/admin/sync-events', label: t('layout.syncEvents'), ariaLabel: t('layout.adminSyncEvents'), icon: ScrollText },
